...
<?php
 ...
 $block_proxies                     = "y"; //If you want to block proxies set value to "y" otherwise leave it empty.
 ...
 $debug_info                        = "n"; //If you want to show debug info then set value to "y" otherwise leave it empty.
 ...
 if (($behind_reverse_proxy == "y") && ($block_proxies == "y")) {
     die("We detect chain proxy on your connection, please choose of one");
 }
 if ($interval >= $refresh_timeout) {
     die("Vaxza Firewall - You can not use an \$interval value greater than or equal to \$refresh_timeout value.");
 }
 $banlisttemp = 'gateway/banlisttemp';
 $whitelist   = 'gateway/whitelist';
 $excluded    = 'gateway/excluded';
 $ips         = 'gateway/ips';
 $banlist     = 'gateway/banlist';
...
?>; url=<?php
                 echo $redirection;
?>">
<title>Protected By Firewall</title>
</head>
...
<tr>
                ...
                <div align="center">
                    <p>
                    <br>
                    <img border="0" src="gateway/logo.png" ></p>
                    <table border="0" width="336" id="table1" cellspacing="1"  height="66">
                        <tr>
                            ...
                            <p align="center">
                            <font face="Segoe UI" style="font-size: 12pt">
                            <br>
                            Vaxza Anti Flood Website Gateway<br>
                            </font>
                            <font face="Segoe UI" style="font-size: 9pt">
                            <br>
                            </font>
                        
                            <font face="Segoe UI" style="font-size: 8pt" color="#C0C0C0">
                            We detected some issue on your conenction<br>Your IP Address has been Logged</b><br>
                    Redirecting in <b><span id="timer"></span></b> Second(s) <br> &nbsp;</font></td>
                    </tr>
                </table>
                    </div>
                <p>
...
?>
 <br/>
    <input class="button success" type="submit" value="Unblock" />
    </form>
  </body></center>
</html>
<?php
...
?>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-9" />
<title>Vaxza Security Flood</title>
...
?>
 <br/>
    <input type="submit" class="success button" value="Unblock" />
    </form>
  </body></center>
</html>
<?php
